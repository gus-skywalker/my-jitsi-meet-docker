...
asap_accepted_issuers = { "my_web_client","my_app_client","meetinglesmonades_api_id" }



asap_accepted_audiences = { "meetinglesmonades_api_id" }
...
VirtualHost "meet.jitsi"
  ...
  authentication = "token"
    app_id = "meetinglesmonades_api_id"
    
    app_secret = "abcdefghij1234567890ABCDEFGHIJKLMNOPQRSTUV"
